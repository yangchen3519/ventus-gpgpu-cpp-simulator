...
typedef enum {
    ...
    VENTUS_CYCLESIM_PARAM_L1_PARTITION_SLOT_BYTES = 8,
    VENTUS_CYCLESIM_PARAM_L1_PARTITION_SLOT_COUNT = 9,
    VENTUS_CYCLESIM_PARAM_L1_MIN_L1D_SLOTS = 10,
    VENTUS_CYCLESIM_PARAM_L1D_SLOT_GRANULARITY = 11,
